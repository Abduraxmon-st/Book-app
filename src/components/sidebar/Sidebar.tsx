  ...
  return (
    <div className="flex items-center">
      <div
        ...
        className={`fixed z-5 transform ${isOpen ? "size-full top-0 left-0 bg-black/10 opacity-100 translate-x-0" : "opacity-0 -translate-x-[110%]"} transition-opacity duration-200 ease-in-out`} />

      <div className={`fixed z-6 top-0 left-0 h-full w-[85%] py-10 pl-5 pr-4 bg-white transform ${isOpen ? 'translate-x-0' : '-translate-x-[110%]'} transition-transform duration-300 ease-in-out shadow-2xl`}>
